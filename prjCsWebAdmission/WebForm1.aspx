<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="prjCsWebAdmission.WebForm1" %>
...
<body>
    <img id="logo" src="photo.jpg" alt="logo" />
     <header class="text-center">
        <h1 class="text-4xl font-bold mt-4">Étudier à l'UQAM</h1>
    ...
    <footer class="mt-8 text-center">
        <p class="text-gray-600">UQAM - Université du Québec à Montréal</p>
