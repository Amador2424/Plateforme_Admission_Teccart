<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="majAdmission2.aspx.cs" Inherits="prjCsWebAdmission.majAdmission2" %>
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <asp:Button ID="btnSoumettre" runat="server" Text="Continuer La Maj" OnClick="btnSoumettre_Click" />
        </div>
