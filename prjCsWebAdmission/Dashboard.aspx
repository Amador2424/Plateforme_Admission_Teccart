<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="prjCsWebAdmission.Dashboard" %>
        ...
        <div class="container">
            ...
            <main class="flex justify-center">
                <div class="w-full max-w-md bg-white p-8 rounded shadow-md">
                    <h3 class="text-xl font-semibold mb-4">Création d'un compte utilisateur</h3>

                     <div class="mb-4">
                        <label for="Nom" class="block text-sm font-medium text-gray-700">Nom</label>
                        <asp:TextBox ID="TxtNom" runat="server" CssClass="w-full p-2 border border-gray-300 rounded" placeholder="Nom" OnTextChanged="TxtNom_TextChanged"></asp:TextBox>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <asp:Button ID="btnSubmit" runat="server" Text="Créer un compte" CssClass="button" OnClick="btnSubmit_Click" Font-Bold="True" />
                    </div>
