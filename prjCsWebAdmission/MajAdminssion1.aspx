<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MajAdminssion1.aspx.cs" Inherits="prjCsWebAdmission.MajAdminssion1" %>
...
<body>
    ...
    <header>
        <h1 class="text-4xl font-bold mt-4">MAJ Info Admission</h1>
    ...
    <form id="form1" runat="server">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drpThrirdChoix" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpThrirdChoix_SelectedIndexChanged"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="auto-style1">
                    <asp:Button ID="btnSuivant" runat="server" Text="Continuer La Maj" OnClick="btnSuivant_Click" />
                </td>
                <td>
