<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="majAdmission3.aspx.cs" Inherits="prjCsWebAdmission.majAdmission3" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <asp:Button ID="btnTelecharger" runat="server" Text="Continuer La Maj" CssClass="btn btn-primary" OnClick="btnTelecharger_Click"  OnClientClick="return confirm('Voux avez jusqu'à 7j pour Pouvoir Modifier votre candidature');" />
            </div>
        </div>
    </form>
</body>
